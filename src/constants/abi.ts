...
export const ERC_721_ABI = [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'limitFreeMint', type: 'uint256' }
    ],
    stateMutability: 'nonpayable',
    type: 'constructor'
  },
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'mintFeeAmount', type: 'uint256' }],
    name: 'setFeePerMint',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function'
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'limitToken', type: 'uint256' }],
    name: 'setLimitFree',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function'
  ...
  {
    inputs: [{ internalType: 'bool', name: 'isPause', type: 'bool' }],
    name: 'setPauseTransfer',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function'
  },
